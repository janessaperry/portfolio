...
import InStockHero from "../assets/images/mockups/mockups-UPDATE.png";
import CustomInput from "../assets/images/code-snippets/build-highlights--custom-input.png"
          ...
          <div className="grid gap-8">
            ...
            <div className="md:col-span-2 flex flex-col gap-4">
              ...
              <LinkButton label={"View website"}
                          href={"https://janessaperry.com/UPDATE"}
                          iconRight={<ArrowSquareOut weight="bold"
                                                     className="text-xl"/>}
              />
            </div>
